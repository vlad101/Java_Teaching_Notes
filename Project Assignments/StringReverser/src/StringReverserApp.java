 ...
 * of the string separated by delimeter whitespace using
 * a string split function and StringTokenizer.
 */
...
class StringReverser
{
    ...
    private String[] splitter;              // Splits the string
    private int count;                      // The number of objects created
    ...
    /**
     * The spliStr method split the string.
     */
     ...
     * string separated by the comma delimeter.
     */
    ...
    /**
     * A counter for the original string.
     */
